...
Expressive play of digital musical instruments (DMIs) via contact microphones on arbitrary surfaces has entered the spotlight through the \textit{Mogees} project\footnote{\url{http://www.brunozamborlin.com/mogees}}.  It excites physical models of string or bell resonators with the input of the microphone, allowing to hit, scratch, and strum any object and turn it into a musical instrument.  
...
Independently of the above, the first author has been using piezo pickups on various surfaces in performances since 2009 \cite{Schwarz-nime2012-sound-space}, exploiting the nuances of a corpus according to the sound of the impacts which is analysed and mapped to
...
audio played by CataRT, the musical interaction still works, as demonstrated in video example~1\footnote{\url{https://eprints.hud.ac.uk/20131}\label{videourl}}. %PERMALINK
...
%%% Local Variables:  %%% mode: latex %%% TeX-master: "../SchwarzHarkerTremblay-nime2014-corpus-convolution" %%% End: 