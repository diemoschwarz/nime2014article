...
Expressive play of digital musical instruments (DMIs) via contact microphones on arbitrary surfaces has entered the spotlight through the \name{Mogees} project\footurl{http://www.brunozamborlin.com/mogees/}  \cite{Zamborlin}.  It excites physical models of string or bell resonators with the input of the microphone, allowing to hit, scratch, and strum any surface and turn it into a musical instrument.  
...
the HIRT, the HISS, and the hoobledyhoo
