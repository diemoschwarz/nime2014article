...
- optimisation: mix ffts, not grains \textbf{(- so 1 convo per grain? (what about a weighted mix of the grains out of the corpus reader in gabor to generate the IR? It gives us 1 convo only... it would work only it all grains are the same size I presume...)}