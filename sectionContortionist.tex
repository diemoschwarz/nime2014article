...
\begin{figure}[htb] 
\begin{center} 
\includegraphics[width=0.8\columnwidth]{figures/flowchart/flowchart.pdf} 
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=\columnwidth]{figures/schwarz_fig2/schwarz_fig2.png}
