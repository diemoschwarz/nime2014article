...
\begin{figure}[tb] 
%\begin{center} 
\includegraphics[width=0.8\columnwidth]{authorea/figures/flowchart/flowchart.pdf} 
...
Technically, in our prototyping system based on \sysname{CataRT}, \sysname{FTM}, and its  \sysname{Gabor} library, the \code{catart.synthesis} module outputs the grain as a 1-column matrix of floating-point numbers (\code{fmat}).  The matrix is copied into a \verb|buffer~| object via the \code{ftm.buffer} module.
...
\begin{figure}[tbh]
\begin{center}
\includegraphics[width=0.7\columnwidth]{authorea/figures/schwarz_fig2/schwarz_fig2.png}
